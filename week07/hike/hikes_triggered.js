...
export default class Hikes {
  ...
  showHikeList(hikeId) {
    ...
    renderHikeList(hikeId, this.getAllHikes(), this.parentElement);
  }
}
...
function renderOneHike(hike) {
  const singleHike = new Hikes('hikes');
...
function renderOneHikeFull(hikeId, hike) {
  ...
  item.innerHTML = `<section>
    ...
    <button id="backBtn" onclick="${singleHike.showHikeList()}">Back</button>
  </section>`;
